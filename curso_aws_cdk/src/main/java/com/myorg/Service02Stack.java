...
public class Service02Stack extends Stack {
    public Service02Stack(final Construct scope, final String id,
                          Cluster cluster, SnsTopic productEventsTopic, Table productEventsDdb) {
        this(scope, id, null, cluster, productEventsTopic, productEventsDdb);
    }

    public Service02Stack(final Construct scope, final String id,
                          final StackProps props, Cluster cluster, SnsTopic productEventsTopic, Table productEventsDdb) {
            ...
            ApplicationLoadBalancedFargateService.Builder.create(this, "ALB02")
                ...
                .taskImageOptions(
                    ApplicationLoadBalancedTaskImageOptions.builder()
                        ...
                        .image(ContainerImage.fromRegistry("braulioti/aws_project02:1.6.0"))
                        .containerPort(9090)
