package io.brau.aws_project01.consumer;

import com.amazonaws.services.s3.AmazonS3;
import com.amazonaws.services.s3.event.S3EventNotification;
import com.amazonaws.services.s3.model.S3Object;
import io.brau.aws_project01.model.Invoice;
import io.brau.aws_project01.model.SnsMessage;
import io.brau.aws_project01.repository.InvoiceRepository;
...
public class InvoiceConsumer {
    ...
    @Autowired
    public InvoiceConsumer(JsonMapper jsonMapper, InvoiceRepository invoiceRepository, AmazonS3 amazonS3) {
    ...
    public void receiveMessage(TextMessage textMessage) throws JMSException, IOException {
        SnsMessage snsMessage = jsonMapper.readValue(textMessage.getText(), SnsMessage.class);
        S3EventNotification s3EventNotification = S3EventNotification.parseJson(snsMessage.getMessage());
    ...
    private void processInvoiceNotification(S3EventNotification s3EventNotification) throws IOException {
        if (s3EventNotification.getRecords() == null || s3EventNotification.getRecords().isEmpty()) {
            LOG.warn("S3 event notification has no records");
            return;
        }
        ...
        for (S3EventNotification.S3EventNotificationRecord
            ...
            Invoice invoice = jsonMapper.readValue(invoiceFile, Invoice.class);
