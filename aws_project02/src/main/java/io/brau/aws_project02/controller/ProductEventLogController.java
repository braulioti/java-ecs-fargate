package io.brau.aws_project02.controller;

import io.brau.aws_project02.model.ProductEventLog;
import io.brau.aws_project02.model.ProductEventLogDto;
...
public class ProductEventLogController {
    ...
    public List<ProductEventLogDto> findByCodeAndEventType(
            @PathVariable String code, @PathVariable String event) {
